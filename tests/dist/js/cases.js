...
TestCases.tracks = function(Player,args,obj,obj_err){
...
TestCases.playPause = function(Player,args,obj,obj_err){
...
TestCases.subs = function(Player,args,obj,obj_err){
	var html = new Player(...args);
	var t1 = new Player.Track(obj);
	var t2 = new Player.Track(obj_err);
	var check = {
...
TestCases.events = function(Player,args,obj,obj_err){
	var html = new Player(...args);
	var t1 = new Player.Track(obj);
	var t2 = new Player.Track(obj_err);
	return html.waitForEvent('ready')
...
TestCases.seek = function(Player,args,obj,obj_err){
	var html = new Player(...args);
	var t1 = new Player.Track(obj);
