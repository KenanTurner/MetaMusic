...
export default class SC extends HTML{
	...
	load(track){
		...
		vol.then(function(v){
			vol = v/100;
			return new Promise(function(res,rej){
				p.catch(rej); //If error is thrown, reject promise
				let o = {
					auto_play: false,
					buying: false,
					sharing: false,
